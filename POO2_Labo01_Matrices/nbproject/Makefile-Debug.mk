...
${OBJECTDIR}/AndMatrix.o: AndMatrix.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AndMatrix.o AndMatrix.cpp
...
${OBJECTDIR}/Operator.o: Operator.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Operator.o Operator.cpp

${OBJECTDIR}/OrMatrix.o: OrMatrix.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OrMatrix.o OrMatrix.cpp

${OBJECTDIR}/XorMatrix.o: XorMatrix.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/XorMatrix.o XorMatrix.cpp
